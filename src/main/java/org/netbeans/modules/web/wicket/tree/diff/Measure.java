...
/**
 * Used for distance measuring of two elements. todo (#pf): Describe mechanism.
 *
...
public class Measure {
    ...
    /**
     * Value representing infinite distance - any distance value equal or
     * greater than this is represented as infinite (i.e. indicates that the
     * compared objects are distinct).
     */
    ...
    /**
     * Compares two objects and returns distance between them. (Value expressing
     * how far they are.)
     *
    ...
    private static final class StringMeasure extends Measure {
         ...
         * @return value between 0 and 100, where 0 means strings are identical,
         * 100 means strings are completly different.
         */
        @Override
        ...
        private static int compareChars(final char xc, final char yc) {
            if (xc == yc) {
                return SAME;
            }
