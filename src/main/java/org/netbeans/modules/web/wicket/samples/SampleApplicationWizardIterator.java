 ...
 * @author Tim Boudreau
 */
public class SampleApplicationWizardIterator implements WizardDescriptor.InstantiatingIterator {
    ...
    public Set instantiate() throws IOException {
        LinkedHashSet<FileObject> resultSet = new LinkedHashSet<>();
