...
/**
 * Implementation of the Longest Common Subsequence algorithm. That is, given
 * two lists <tt>oldL</tt> and <tt>newL</tt>, this class will find the longest
 * sequence objects that are common and ordered in <tt>oldL</tt> and
 * <tt>newL</tt>.
 *
 * @author Pavel Flaska
 */
public final class ListMatcher<E> {
     ...
     * @param oldL old array of elements to compare.
     * @param newL new array of elements to compare.
     * @param measure the diff's measure
     * @return created instance.
     */
    ...
    static final class ResultItem<S> {
         ...
         * Creates an instance.
         *
         * @param element element which differs. New element when insert or
         * modify, old element when nochange or delete.
    ...
    /**
     * Computes the lists differences. Just call this method after instance is
     * created.
     *
    ...
    ResultItem<E>[] getTransformedResult() {
        ...
        ArrayList<ResultItem<E>> temp = new ArrayList<>(copy.size());
        while (!copy.empty()) {
